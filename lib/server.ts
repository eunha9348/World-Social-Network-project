...
const PROVIDERS={openai:{base:'https://api.openai.com/v1',key:'OPENAI_API_KEY',chat:'gpt-4.1-mini',embed:'text-embedding-3-small'},gemini:{base:'https://generativelanguage.googleapis.com/v1beta/openai',key:'GOOGLE_API_KEY',chat:'gemini-2.5-flash',embed:'gemini-embedding-001'}} as const;
